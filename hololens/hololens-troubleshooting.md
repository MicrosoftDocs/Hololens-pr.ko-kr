...
- 디바이스 리플래시
    ...
    1. 연결되지 않은 상태에서 전원을 완전히 낮추어 HoloLens 2 수동으로 [플래시 모드로](hololens-recovery.md) 전환합니다. 그런 다음, Volume up 동안 전원 단추를 탭합니다.
...
- Microsoft Store 모든 앱이 에뮬레이터와 호환되는 것은 아닙니다. 예를 들어 Young Conker 및 Fragments는 에뮬레이터에서 재생할 수 없습니다.
...
Cortana 음성 명령에 응답하지 않는 경우 Cortana 켜져 있는지 확인합니다. 모든 앱 목록에서 **Cortana** 메뉴 Notebook 설정 선택하여  >    >    >   변경합니다. 할 수 있는 내용에 대한 자세한 내용은 [HoloLens 음성 사용을 참조하세요.](hololens-cortana.md)
