...
### 파일 탐색기를 사용 하 여 사진, 동영상, 파일 가져오기

다른 모바일 장치와 유사 하 게, HoloLens를 PC에 연결 하 여 파일 탐색기를 통해 HoloLens 라이브러리 (사진, 비디오, 문서)에 액세스 하 여 쉽게 전송할 수 있습니다. 이 방법은 사용이 간편 하며 장치 포털 또는 Wi-fi를 사용할 필요가 없습니다.

1. 장치 잠금을 해제 합니다.
1. USB를 통해 장치를 PC에 연결 합니다.
1. PC에서 파일 탐색기를 열어야 합니다.
1. 이동:이 PC\\*yourhololensname*\Internal Storage\Pictures\Camera 롤
