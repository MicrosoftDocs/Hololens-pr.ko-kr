...
그런 다음 **Windows의 활성 개발**을 선택 하 고, **빠른** 빌드를 받을지 **느리게** 표시할지를 선택 하 고, 프로그램 약관을 검토 합니다.
...
[Windows 홀로그램에서 2020 Feautres 업데이트](hololens-release-notes.md) 릴리스 모든 릴리스 미리 보기는 이제 일반적으로 avalible! 최신 기능을 모두 얻으려면 [HoloLens를 업데이트](hololens-update-hololens.md) 해야 합니다.  
