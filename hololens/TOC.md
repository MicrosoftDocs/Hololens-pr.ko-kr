...
### [HoloLens 업데이트](hololens-update-hololens.md)
## 일일 사용량
### Windows Holographic 인터페이스 탐색
#### [시작 메뉴 및 혼합 현실 홈 사용](holographic-home.md)
...
# HoloLens 2 배포
## [일반 배포 시나리오](hololens-requirements.md)
## [HoloLens 2 배포 계획](hololens-core-components.md)
## 배포 가이드
### 클라우드 연결 환경 배포 가이드
#### [개요](hololens2-cloud-connected-overview.md)
#### [준비](hololens2-cloud-connected-prepare.md)
...
#### [구성](hololens2-corp-connected-configure.md)
#### [배포](hololens2-corp-connected-deploy.md)
#### [유지 관리](hololens2-corp-connected-maintain.md)
...
### [MAC 주소 제한 Wi-Fi 환경에 등록](mac-address-options.md)
## 애플리케이션 개발
...
# 문제 해결
## [디바이스](hololens-troubleshooting.md)
## [홀로그램 및 상호 작용](hololens-faq.md)
