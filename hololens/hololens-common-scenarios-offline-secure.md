...
1. [Microsoft Store](https://www.microsoft.com/store/productId/9P74Z35SFRS8) ARC(Advanced Recovery Companion) 도구를 다운로드/설치하여 PC로
1. Microsoft Store PC로 최신 [WCD(Windows 구성 디자이너)](https://www.microsoft.com/p/windows-configuration-designer/9nblggh4tx22?activetab=pivot:overviewtab) 도구를 다운로드/설치합니다.
